#ifndef _LIB_HM11_SoftwareSerial2_H_
#define _LIB_HM11_SoftwareSerial2_H_
/*******************************************************************************
* \file    HM11_SoftwareSerial2.h
********************************************************************************
* \author  Jascha Haldemann jh@oxon.ch
* \date    01.04.2017
* \version 1.0
*
* \brief   SoftwareSerial2 implementation for the HM11
*
* \section DESCRIPTION
* Instantiate this class if you want to control the HM11 with a SoftwareSerial2
* interface
*
********************************************************************************
* BLE Library
...
/* ============================ Class declaration =========================== */
class HM11_SoftwareSerial2 : public HM11
{
public:
  ...
  HM11_SoftwareSerial2(SoftwareSerial2& BLESerial,
  ...
  ~HM11_SoftwareSerial2() {};
  // Example instantation:
  // SoftwareSerial2 BLESerial(8, 9);
  // HM11_SoftwareSerial2 BLE(BLESerial, &PORTD, 8, &PORTD, 9, &PORTD, 7, &PORTB, 0);
