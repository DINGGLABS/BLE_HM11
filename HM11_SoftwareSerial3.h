#ifndef _LIB_HM11_SoftwareSerial3_H_
#define _LIB_HM11_SoftwareSerial3_H_
/*******************************************************************************
* \file    HM11_SoftwareSerial3.h
********************************************************************************
* \author  Jascha Haldemann jh@oxon.ch
* \date    01.04.2017
* \version 1.0
*
* \brief   SoftwareSerial3 implementation for the HM11
*
* \section DESCRIPTION
* Instantiate this class if you want to control the HM11 with a SoftwareSerial3
* interface
*
********************************************************************************
* BLE Library
...
/* ============================ Class declaration =========================== */
class HM11_SoftwareSerial3 : public HM11
{
public:
  ...
  HM11_SoftwareSerial3(SoftwareSerial3& BLESerial,
  ...
  ~HM11_SoftwareSerial3() {};
  // Example instantation:
  // SoftwareSerial3 BLESerial(8, 9);
  // HM11_SoftwareSerial3 BLE(BLESerial, &PORTD, 8, &PORTD, 9, &PORTD, 7, &PORTB, 0);
