#ifndef _LIB_HM11_SoftwareSerial1_H_
#define _LIB_HM11_SoftwareSerial1_H_
/*******************************************************************************
* \file    HM11_SoftwareSerial1.h
********************************************************************************
* \author  Jascha Haldemann jh@oxon.ch
* \date    01.04.2017
* \version 1.0
*
* \brief   SoftwareSerial1 implementation for the HM11
*
* \section DESCRIPTION
* Instantiate this class if you want to control the HM11 with a SoftwareSerial1
* interface
*
* \license LGPL-V2.1
...
/* ============================ Class declaration =========================== */
class HM11_SoftwareSerial1 : public HM11
{
public:
  ...
  HM11_SoftwareSerial1(SoftwareSerial1& BLESerial,
  ...
  ~HM11_SoftwareSerial1() {};
  // Example instantation:
  // SoftwareSerial1 BLESerial(8, 9);
  // HM11_SoftwareSerial1 BLE(BLESerial, &PORTD, 8, &PORTD, 9, &PORTD, 7, &PORTB, 0);
